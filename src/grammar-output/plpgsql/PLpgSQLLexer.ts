...
export class PLpgSQLLexer extends Lexer {
	...
	public static readonly ANALYZE = 367;
	public static readonly AND = 368;
	public static readonly ANY = 369;
	public static readonly ARRAY = 370;
	public static readonly AS = 371;
	public static readonly ASC = 372;
	public static readonly ASYMMETRIC = 373;
	public static readonly BOTH = 374;
	public static readonly CASE = 375;
	public static readonly CAST = 376;
	public static readonly CHECK = 377;
	public static readonly COLLATE = 378;
	public static readonly COLUMN = 379;
	public static readonly CONSTRAINT = 380;
	public static readonly CREATE = 381;
	public static readonly CURRENT_CATALOG = 382;
	public static readonly CURRENT_DATE = 383;
	public static readonly CURRENT_ROLE = 384;
	public static readonly CURRENT_TIME = 385;
	public static readonly CURRENT_TIMESTAMP = 386;
	public static readonly CURRENT_USER = 387;
	public static readonly DEFAULT = 388;
	public static readonly DEFERRABLE = 389;
	public static readonly DESC = 390;
	public static readonly DISTINCT = 391;
	public static readonly DO = 392;
	public static readonly ELSE = 393;
	public static readonly END = 394;
	public static readonly EXCEPT = 395;
	public static readonly FALSE = 396;
	public static readonly FETCH = 397;
	public static readonly FOR = 398;
	public static readonly FOREIGN = 399;
	public static readonly FROM = 400;
	public static readonly GRANT = 401;
	public static readonly GROUP = 402;
	public static readonly HAVING = 403;
	public static readonly IN = 404;
	public static readonly INITIALLY = 405;
	public static readonly INTERSECT = 406;
	public static readonly INTO = 407;
	public static readonly LATERAL = 408;
	public static readonly LEADING = 409;
	public static readonly LIMIT = 410;
	public static readonly LOCALTIME = 411;
	public static readonly LOCALTIMESTAMP = 412;
	public static readonly NOT = 413;
	public static readonly NULL = 414;
	public static readonly OFFSET = 415;
	public static readonly ON = 416;
	public static readonly ONLY = 417;
	public static readonly OR = 418;
	public static readonly ORDER = 419;
	public static readonly PLACING = 420;
	public static readonly PRIMARY = 421;
	public static readonly REFERENCES = 422;
	public static readonly RETURNING = 423;
	public static readonly SELECT = 424;
	public static readonly SESSION_USER = 425;
	public static readonly SOME = 426;
	public static readonly SYMMETRIC = 427;
	public static readonly TABLE = 428;
	public static readonly THEN = 429;
	public static readonly TO = 430;
	public static readonly TRAILING = 431;
	public static readonly TRUE = 432;
	public static readonly UNION = 433;
	public static readonly UNIQUE = 434;
	public static readonly USER = 435;
	public static readonly USING = 436;
	public static readonly VARIADIC = 437;
	public static readonly WHEN = 438;
	public static readonly WHERE = 439;
	public static readonly WINDOW = 440;
	public static readonly WITH = 441;
	public static readonly ALIGNMENT = 442;
	public static readonly BASETYPE = 443;
	public static readonly BUFFERS = 444;
	public static readonly BYPASSRLS = 445;
	public static readonly CANONICAL = 446;
	public static readonly CATEGORY = 447;
	public static readonly COLLATABLE = 448;
	public static readonly COMBINEFUNC = 449;
	public static readonly COMMUTATOR = 450;
	public static readonly CONNECT = 451;
	public static readonly COSTS = 452;
	public static readonly CREATEDB = 453;
	public static readonly CREATEROLE = 454;
	public static readonly DESERIALFUNC = 455;
	public static readonly DETERMINISTIC = 456;
	public static readonly DISABLE_PAGE_SKIPPING = 457;
	public static readonly ELEMENT = 458;
	public static readonly EXTENDED = 459;
	public static readonly FINALFUNC = 460;
	public static readonly FINALFUNC_EXTRA = 461;
	public static readonly FINALFUNC_MODIFY = 462;
	public static readonly FORCE_NOT_NULL = 463;
	public static readonly FORCE_NULL = 464;
	public static readonly FORCE_QUOTE = 465;
	public static readonly FORMAT = 466;
	public static readonly GETTOKEN = 467;
	public static readonly HASH = 468;
	public static readonly HASHES = 469;
	public static readonly HEADLINE = 470;
	public static readonly HYPOTHETICAL = 471;
	public static readonly INDEX_CLEANUP = 472;
	public static readonly INIT = 473;
	public static readonly INITCOND = 474;
	public static readonly INTERNALLENGTH = 475;
	public static readonly JSON = 476;
	public static readonly LC_COLLATE = 477;
	public static readonly LC_CTYPE = 478;
	public static readonly LEFTARG = 479;
	public static readonly LEXIZE = 480;
	public static readonly LEXTYPES = 481;
	public static readonly LIST = 482;
	public static readonly LOCALE = 483;
	public static readonly LOGIN = 484;
	public static readonly MAIN = 485;
	public static readonly MERGES = 486;
	public static readonly MFINALFUNC = 487;
	public static readonly MFINALFUNC_EXTRA = 488;
	public static readonly MFINALFUNC_MODIFY = 489;
	public static readonly MINITCOND = 490;
	public static readonly MINVFUNC = 491;
	public static readonly MODULUS = 492;
	public static readonly MSFUNC = 493;
	public static readonly MSSPACE = 494;
	public static readonly MSTYPE = 495;
	public static readonly NEGATOR = 496;
	public static readonly NOBYPASSRLS = 497;
	public static readonly NOCREATEDB = 498;
	public static readonly NOCREATEROLE = 499;
	public static readonly NOINHERIT = 500;
	public static readonly NOLOGIN = 501;
	public static readonly NOREPLICATION = 502;
	public static readonly NOSUPERUSER = 503;
	public static readonly OUTPUT = 504;
	public static readonly PASSEDBYVALUE = 505;
	public static readonly PATH = 506;
	public static readonly PERMISSIVE = 507;
	public static readonly PLAIN = 508;
	public static readonly PREFERRED = 509;
	public static readonly PROVIDER = 510;
	public static readonly READ_ONLY = 511;
	public static readonly READ_WRITE = 512;
	public static readonly RECEIVE = 513;
	public static readonly REMAINDER = 514;
	public static readonly REPLICATION = 515;
	public static readonly RESTRICTED = 516;
	public static readonly RESTRICTIVE = 517;
	public static readonly RIGHTARG = 518;
	public static readonly SAFE = 519;
	public static readonly SEND = 520;
	public static readonly SERIALFUNC = 521;
	public static readonly SETTINGS = 522;
	public static readonly SFUNC = 523;
	public static readonly SHAREABLE = 524;
	public static readonly SKIP_LOCKED = 525;
	public static readonly SORTOP = 526;
	public static readonly SSPACE = 527;
	public static readonly STYPE = 528;
	public static readonly SUBTYPE_DIFF = 529;
	public static readonly SUBTYPE_OPCLASS = 530;
	public static readonly SUBTYPE = 531;
	public static readonly SUMMARY = 532;
	public static readonly SUPERUSER = 533;
	public static readonly TIMING = 534;
	public static readonly TYPMOD_IN = 535;
	public static readonly TYPMOD_OUT = 536;
	public static readonly UNSAFE = 537;
	public static readonly USAGE = 538;
	public static readonly VARIABLE = 539;
	public static readonly YAML = 540;
	public static readonly ALIAS = 541;
	public static readonly ASSERT = 542;
	public static readonly CONSTANT = 543;
	public static readonly DATATYPE = 544;
	public static readonly DEBUG = 545;
	public static readonly DETAIL = 546;
	public static readonly DIAGNOSTICS = 547;
	public static readonly ELSEIF = 548;
	public static readonly ELSIF = 549;
	public static readonly ERRCODE = 550;
	public static readonly EXIT = 551;
	public static readonly EXCEPTION = 552;
	public static readonly FOREACH = 553;
	public static readonly GET = 554;
	public static readonly HINT = 555;
	public static readonly INFO = 556;
	public static readonly LOG = 557;
	public static readonly LOOP = 558;
	public static readonly MESSAGE = 559;
	public static readonly NOTICE = 560;
	public static readonly OPEN = 561;
	public static readonly PERFORM = 562;
	public static readonly QUERY = 563;
	public static readonly RAISE = 564;
	public static readonly RECORD = 565;
	public static readonly RETURN = 566;
	public static readonly REVERSE = 567;
	public static readonly ROWTYPE = 568;
	public static readonly SLICE = 569;
	public static readonly SQLSTATE = 570;
	public static readonly STACKED = 571;
	public static readonly WARNING = 572;
	public static readonly WHILE = 573;
	public static readonly CAST_EXPRESSION = 574;
	public static readonly EQUAL = 575;
	public static readonly COLON = 576;
	public static readonly SEMI_COLON = 577;
	public static readonly COMMA = 578;
	public static readonly NOT_EQUAL = 579;
	public static readonly LTH = 580;
	public static readonly LEQ = 581;
	public static readonly GTH = 582;
	public static readonly GEQ = 583;
	public static readonly LEFT_PAREN = 584;
	public static readonly RIGHT_PAREN = 585;
	public static readonly PLUS = 586;
	public static readonly MINUS = 587;
	public static readonly MULTIPLY = 588;
	public static readonly DIVIDE = 589;
	public static readonly MODULAR = 590;
	public static readonly EXP = 591;
	public static readonly DOT = 592;
	public static readonly QUOTE_CHAR = 593;
	public static readonly DOUBLE_QUOTE = 594;
	public static readonly DOLLAR = 595;
	public static readonly LEFT_BRACKET = 596;
	public static readonly RIGHT_BRACKET = 597;
	public static readonly EQUAL_GTH = 598;
	public static readonly COLON_EQUAL = 599;
	public static readonly LESS_LESS = 600;
	public static readonly GREATER_GREATER = 601;
	public static readonly DOUBLE_DOT = 602;
	public static readonly HASH_SIGN = 603;
	public static readonly BlockComment = 604;
	public static readonly LineComment = 605;
	public static readonly OP_CHARS = 606;
	public static readonly NUMBER_LITERAL = 607;
	public static readonly REAL_NUMBER = 608;
	public static readonly DOLLAR_NUMBER = 609;
	public static readonly Identifier = 610;
	public static readonly QuotedIdentifier = 611;
	public static readonly Character_String_Literal = 612;
	public static readonly BeginDollarStringConstant = 613;
	public static readonly Space = 614;
	public static readonly White_Space = 615;
	public static readonly New_Line = 616;
	public static readonly Tab = 617;
	public static readonly BOM = 618;
	public static readonly BAD = 619;
	public static readonly Text_between_Dollar = 620;
	public static readonly EndDollarStringConstant = 621;
	...
	*/
	...
	private static readonly _serializedATNSegment4: string =
		"\x02\u0250\u0DC0\x03\x02\x02\x02\u0252\u0DC4\x03\x02\x02\x02\u0254\u0DCC" +
	...
	private static readonly _serializedATNSegment7: string =
		"\x02\u0D6A\u0D6B\t\x04\x02\x02\u0D6B\u0D6C\t\b\x02\x02\u0D6C\u0D6D\t\x02" +
	...
	private static readonly _serializedATNSegment9: string =
		"\x10\x02\x02\u13ED\u13EE\t\t\x02\x02\u13EE\u13EF\t\r\x02\x02\u13EF\u13F0" +
	...
	private static readonly _serializedATNSegment10: string =
		"\x02\u171E\u1720\x03\x02\x02\x02\u171F\u1721\x05\u04E6\u0273\x02\u1720" +
